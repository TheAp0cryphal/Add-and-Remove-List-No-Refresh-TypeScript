...
export class View {
    ...
    static displayPigs(pigList) {
        ...
        pigList.forEach(function (pig) {
            ...
            for (let i = 0; i < 8; i++) {
                ...
                more_info_col_value.textContent = pig[pig_attributes[i]].toString();
    ...
    static displayOverlay() {
        ...
        elem === null || elem === void 0 ? void 0 : elem.setAttribute("open", "");
    ...
    static closeOverlay() {
        ...
        const elem = document.querySelector('#overlay_add');
        const overlay = document.querySelector("#overlay");
        elem === null || elem === void 0 ? void 0 : elem.removeAttribute("open");
        overlay.style.display = 'none';
    }
    static displayInfo(pig) {
        //
    }
}
